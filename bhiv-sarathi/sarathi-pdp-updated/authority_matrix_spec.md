...
| Hash algorithm | SHA-256 over canonical JSON of the sorted rules array |
| Hash computation | Computed from a lexically sorted `rules` slice to ensure immunity against JSON file key/ordering changes. |
