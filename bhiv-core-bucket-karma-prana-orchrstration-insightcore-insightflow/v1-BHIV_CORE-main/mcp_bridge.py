...
async def handle_task_request(payload: TaskPayload) -> dict:
    ...
    try:
        ...
        try:
            emit_pravah_signal(state="running", latency_ms=processing_time * 1000)
        except Exception:
            pass
        ...
        try:
            ...
            pass
        try:
            p_time = (datetime.now() - start_time).total_seconds()
            emit_pravah_signal(state="degraded", latency_ms=p_time * 1000, errors_last_min=1)
        except Exception:
            pass
