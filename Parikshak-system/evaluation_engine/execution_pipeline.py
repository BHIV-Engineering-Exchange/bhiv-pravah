...
class ExecutionPipeline:
    ...
    def _persist(self, output, task_data, eval_output, graph_result):
        ...
        try:
            ...
            # Populate engineering review details in review_record.analysis
