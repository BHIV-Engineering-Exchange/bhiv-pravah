...
def test_single_authority_system():
    ...
    valid_result = process_legacy_convergence(
        ...
        schema_version="v1.0",
        trace_id="trace-test-single-authority"
    )
    ...
    invalid_result = process_legacy_convergence(
        task_title="Test Task",
        task_description="Test description",
        repository_url="https://github.com/user/test",
        module_id="invalid-module",
        schema_version="v1.0",
        trace_id="trace-test-invalid-registry"
    )
...
def test_determinism():
    ...
    test_input = {
        ...
        "module_id": "task-review-agent",
        "schema_version": "v1.0",
        "trace_id": "trace-test-determinism"
    }
    
    results = []
    for i in range(3):
        result = process_legacy_convergence(**test_input)
        results.append({
