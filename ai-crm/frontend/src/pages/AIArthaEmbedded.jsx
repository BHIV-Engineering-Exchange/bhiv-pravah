...
export const AIArthaEmbedded = () => {
  const handleOpenInNewTab = () => {
    window.open(AI_ARTHA_DASHBOARD_URL, '_blank', 'noopener,noreferrer');
  };

  const handleReloadFrame = () => {
    const frame = document.getElementById('ai-artha-dashboard-frame');
    ...
    <div className="space-y-4 animate-fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            AI Artha dashboard embedded inside SETU
          </p>
        </div>
      ...
      <div className="rounded-xl border border-border bg-card/30 p-2">
        <iframe
          ...
          title="AI Artha Dashboard"
          src={AI_ARTHA_DASHBOARD_URL}
