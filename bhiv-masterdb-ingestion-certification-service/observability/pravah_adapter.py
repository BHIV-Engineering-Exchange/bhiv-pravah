...
pravah_adapter.py
==================
Pravah Bhiv observation adapter for bhiv-masterdb-ingestion-certification-service.
...
Usage:
    ...
    emit_pravah_signal(state="running", latency_ms=45.0)
...
APP_NAME = "bhiv-masterdb-ingestion-certification-service"
...
def _send(payload: dict) -> None:
    ...
    trace_id = f"masterdb-{uuid.uuid4().hex[:16]}"
