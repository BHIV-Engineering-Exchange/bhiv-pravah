...
pravah_adapter.py
==================
Pravah Bhiv observation adapter for bhiv-svacs-unified-core runtime.
...
Usage:
    ...
    emit_pravah_signal(state="running", latency_ms=42.0)
...
APP_NAME = "bhiv-svacs-unified-core"
...
def _send(payload: dict) -> None:
    ...
    trace_id = f"svacs-{uuid.uuid4().hex[:16]}"
